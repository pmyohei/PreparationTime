...
public class AsyncTaskTableOperaion extends AsyncTask<Void, Void, Integer> {
    ...
    protected void onPostExecute(Integer code) {
        ...
        if (listener != null) {
            ...
            if( this.operation == DB_OPERATION.READ ){
                ...
                //処理終了：新規作成
                listener.onSuccessTaskCreate(code, this.task, this.taskTime);
                ...
                //処理終了：更新
                listener.onSuccessTaskUpdate(this.preTask, this.preTaskTime, this.task, this.taskTime);
    ...
    interface TaskOperationListener {
         ...
         * 新規生成完了時
         */
        void onSuccessTaskCreate(Integer code, String task, int taskTime );
         ...
         * 更新完了時
         */
        void onSuccessTaskUpdate(String preTask, int preTaskTime, String task, int taskTime);
